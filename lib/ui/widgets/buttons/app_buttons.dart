    ...
    _builder = (context) {
      ...
      Text? txt = text == null
          ...
          : Text(text.toUpperCase(),
              style: $styles.text.copy($styles.text.defaultFont,
                  sizePx: 12, weight: FontWeight.w600, heightPx: 13.2),
              textHeightBehavior:
      ...
      if (txt != null && icn != null) {
        return Row(
          ...
          children: [txt, ($styles.insets.xs).addWSpace(), icn],
        );
      } else {
        return (txt ?? icn)!;
      }
...
class BasicBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Widget button = GestureDetector(
      excludeFromSemantics: true,
      onTap:
          enableFeedback ? Feedback.wrapForTap(onPressed, context) : onPressed,
      behavior: behavior,
      child: child,
    );
    ...
    if (semanticLabel != null)
      button = Semantics(
          label: semanticLabel, button: true, container: true, child: button);
